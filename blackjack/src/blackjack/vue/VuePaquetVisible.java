		  ...
		  System.out.print(this.getHeight() );
			  ...
			  case "playerSimple":
				  for(int i=0; i<this.paquet.getPaquetSize(); i++) {
					  ...
					  if (i==0){
						  try{
							  File filename = new File("blackjack/src/PNG/Medium/" +c.getValeur() + "_" + c.getCouleur() +".png"		  	 );
				  ...
				  for(int i=0; i<this.paquet.getPaquetSize(); i++) {
					  ...
					  if (i==0){
						  ...
						  if(!this.hideCardDealer){
							  try {
								  File filenamehide = new File("blackjack/src/PNG/Medium/ARRIERE.png"		  	 );
			  ...
			  for(int i=0; i<this.paquet2.getPaquetSize(); i++) {
				  Carte c2 = this.paquet2.getPaquet().get(i);
					  if (i==0){
						  try{
							  File filename2 = new File("blackjack/src/PNG/Medium/" +c2.getValeur() + "_" + c2.getCouleur() +".png"		  	 );
